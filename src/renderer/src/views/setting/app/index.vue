...
const openUserSetting = () => window.ipc.createChildWindow({ width: 800, height: 500, url: '/main/setting/user', parents: window.instance_name.my })
</script>
